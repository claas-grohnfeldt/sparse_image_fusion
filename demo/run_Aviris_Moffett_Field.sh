...
#----------------
job_name='JSparseFIHM_Aviris_Moffett_Field'

#----------------------------------
# paths
#----------------------------------

DIR_DATA_BASE='./data/HS_MS/Aviris_Moffett_Field'
...
_Moffett_Field_synthesized_QuickBird_MSHR_SNR35.dat"
...
Moffett_Field_synthesized_HSLR_fDS4_SNR35.dat"
...
#----------------
filename_ImZ_init="${DIR_DATA_BASE}/FusionResults/CNMF/Aviris_Moffett\
_Field_FusionResult_CNMF.dat"
...
#----------------
filename_ImZ_ref="${DIR_DATA_BASE}/ReferenceData/Aviris_Moffett_Field\
_hyperspectral_highRes_reference.dat"
...
ed_to_centers_of_SRFs_of_Aviris_for_scene_Moffett_Field.csv"
