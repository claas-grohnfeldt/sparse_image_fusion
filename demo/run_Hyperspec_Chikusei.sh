...
#----------------
job_name='JSparseFIHM_Hyperspec_Chikusei'

#----------------------------------
# paths
#----------------------------------

DIR_DATA_BASE='./data/HS_MS/Hyperspec_Chikusei'

#----------------
# 2: Filename of image with higher spatial resolution (string) 
#----------------
filename_ImX="${DIR_DATA_BASE}/InputData/multispectral_highRes/Hypers\
pec_Chikusei_synthesized_WorldView2_MSHR_SNR35.dat"

#----------------
# 3: Filename of image with lower spatial resolution higher spectral 
#    resolution (string)
#----------------
filename_ImY="${DIR_DATA_BASE}/InputData/hyperspectral_lowRes/Hypersp\
ec_Chikusei_synthesized_HSLR_fDS6_SNR35.dat"
...
#----------------
filename_ImZ_init="${DIR_DATA_BASE}/FusionResults/CNMF/Hyperspec_Chik\
usei_FusionResult_CNMF.dat"
...
#----------------
filename_ImZ_ref="${DIR_DATA_BASE}/ReferenceData/Hyperspec_Chikusei_h\
yperspectral_highRes_reference.dat"
...
#    (bool)
#----------------
filename_SRF="${DIR_DATA_BASE}/InputData/SRFs/SRFs_of_WorldView2_samp\
led_to_centers_of_SRFs_of_Hyperspec_for_scene_Chikusei.csv"
