...
#----------------
job_name='JSparseFIHM_Aviris_Cuprite'

#----------------------------------
# paths
#----------------------------------

DIR_DATA_BASE='./data/HS_MS/Aviris_Cuprite'
...
_Cuprite_sc03_synthesized_WorldView3_MSHR_SNR35.dat"
...
Cuprite_sc03_synthesized_HSLR_fDS5_SNR35.dat"
...
#----------------
filename_ImZ_init="${DIR_DATA_BASE}/FusionResults/CNMF/Aviris_Cuprite\
_FusionResult_CNMF.dat"
...
#----------------
filename_ImZ_ref="${DIR_DATA_BASE}/ReferenceData/Aviris_Cuprite_hyper\
spectral_highRes_reference.dat"
...
led_to_centers_of_SRFs_of_Aviris_for_scene_Cuprite.csv"
...
#     sub-groups. (int)
#     checked and perhaps split into subgoups (int) 
#----------------
N_c='30'
...
#     resolved image) should be written to a file. (bool)
#----------------
writeImageFile='1'
